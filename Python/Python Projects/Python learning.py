...
#IF ELSE COMPARISONS
##def max_num(num1,num2,numb3):
   # if num1 >= num2 and num1 >=numb3:
     #   return num1
    #elif num2 >= num1 and num2 >=numb3:
   #     return num2
  #  else:
 #       return numb3
...
# Jan -> January
# Feb -> Feburary
# dictionary = {unique key value pairs}
Monthconversion = {
    "Jan": "January",
    "Feb": "February",
    "Mar": "March",
...
print(Monthconversion[input("Input the first 3 letter characters of the month you need to spell: ")])
#print whole name for Nov
